    ...
    <section class="indexW">
      <div class="ed-container">
        <div class="ed-item web-100"><img src="img/bg-vieja.jpg" alt="" class="clave"/>
          ...
          <h2>Mientras más Zuko y Livean compres, más opciones tienes de ganar hasta $300.000 semanales, participando en cualquiera de estas categorías:</h2>
          <div class="giftcardsM">
            <div class="giftM"><img src="img/gift_oro.png" alt=""/></div>
            <div class="giftM"><img src="img/gift_plata.png" alt=""/></div>
            <div class="giftM"><img src="img/gift_bronce.png" alt=""/></div>
          </div>
          <div class="giftcardsW">
            <div class="giftW"><img src="img/gift_oro_w.png" alt=""/></div>
            <div class="giftW"><img src="img/gift_plata_w.png" alt=""/></div>
            <div class="giftW"><img src="img/gift_bronce_w.png" alt=""/></div>
          </div>
