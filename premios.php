    ...
    <section class="indexW">
      <div class="ed-container">
        <div class="ed-item web-100"><img src="img/bg-vieja.jpg" alt="" class="clave"/>
          ...
          <div class="premios-caja">
            <h1>Premios</h1>
            <p> <span>
                 
                BRONCE</span>Por compras superiores a $5.000, hasta $10.000 en la semana, estás participando por 20 premios semanales de $20.000</p>
            <p> <span>
                 
                PLATA</span>Por compras superiores a $10.001, hasta $35.000 en la semana,  estás participando por 10 premios semanales de $50.000</p>
            <p> <span>
                 
                ORO</span>Por compras superiores a $35.001 en la semana, estás participando por 2 premios semanales de $300.000</p>
          </div>
